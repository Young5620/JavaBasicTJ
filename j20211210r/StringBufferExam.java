...
public class StringBufferExam {
    public static void main(String[] args) {
        ...
        // 첫번째 예제는 StringBuffer는 객체가 한번만 생성된다.
        // 두번째 예제 String 예제는 자료형이 + 연산이 사용될 때마다 계속 새로운 객체가 추가되어 생성된다.
        // (새로운 객체를 만들어낸다.)
        ...
        // 그렇다고 무조건 StringBuffer를 사용하는 것이 좋은가?
        // 상황에 따라 다르다. StringBuffer는 기본적으로 String보다 무겁다.
